...
| Página Consulta de Dados | CT 2 | Validar pesquisa por dados | Idem Caso 1 |  1. Abrir página home <br> 2. Clicar em 'Consulta' <br> 3. Digitar CPF cadastrado <br> 4. Clicar em consultar. |    |
