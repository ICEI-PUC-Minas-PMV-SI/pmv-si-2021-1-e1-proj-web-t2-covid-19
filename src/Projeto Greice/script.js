...
let varLocal = localStorage.getItem("varLocal");
let varServico = localStorage.getItem("varServico");
...
document.getElementById("btn-prox-1").addEventListener("click", function() {
    ...
    var varLocal = document.getElementById("Categoria").value;
    localStorage.setItem("varLocal", varLocal);

    var varServico = document.addEventListener("Servico").value;
